...
// simulations, and the ReportingSimulator interface implements Simulator
// with an extra AddReporter method to inject Reporter interfaces to recieve
// callbacks from hooks inside the Simulator during execution.
//
